...
use Acme\App\Core\Component\Blog\Application\Query\DQL\FindHighestPostSlugSuffixQuery;
...
class FindHighestPostSlugSuffixQueryIntegrationTest extends AbstractIntegrationTest
{
    /**
     * @test
     */
    public function execute(): void
    {
        ...
        self::assertSame($maxSuffix, $this->getFindHighestPostSlugSuffixQuery()->execute($post1->getSlug()));
    }

    /**
     * @test
     */
    public function execute_returns_zero_if_only_stem_slug_found(): void
    {
        $titleStem = 'Some Interesting Title';
        $author = $this->getAnAuthor();
        ...
        self::assertSame(0, $this->getFindHighestPostSlugSuffixQuery()->execute($post->getSlug()));
    }
    ...
    public function execute_throws_exception_if_slug_not_found(): void
    {
        ...
        $this->getFindHighestPostSlugSuffixQuery()->execute($post->getSlug());
    }
    ...
    private function getFindHighestPostSlugSuffixQuery(): FindHighestPostSlugSuffixQueryInterface
    {
        return self::getService(FindHighestPostSlugSuffixQuery::class);
    }
}
